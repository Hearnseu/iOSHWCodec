...
//        NSDictionary *dic=@{(__bridge NSString*)kCVPixelBufferPixelFormatTypeKey:@(kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange)};
        
		OSStatus status = VTCompressionSessionCreate(NULL, (int32_t)width, (int32_t)height, codec, NULL, NULL, NULL, VideoCompressonOutputCallback, (__bridge void *)self, &compressionSession);
		if(status != noErr)
		{
            ...
            _cvpixelBufferPool=VTCompressionSessionGetPixelBufferPool(compressionSession);
